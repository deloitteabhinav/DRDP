...
2 * (
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND(OR(ISCHANGED(Duration_Type__c),
     ISCHANGED(Activity_Duration__c)), ISPICKVAL( Duration_Type__c ,&apos;Business Days&apos;))</formula>
    ...
    <rules>
        ...
        <active>true</active>
        <formula>AND(OR(ISCHANGED(Duration_Type__c),
     ISCHANGED(Activity_Duration__c)), ISPICKVAL( Duration_Type__c ,&apos;Calendar Days&apos;))</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
